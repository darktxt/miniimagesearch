...
QT_MOC_LITERAL(1, 14, 22), // "on_applyButton_clicked"
QT_MOC_LITERAL(2, 37, 0) // ""

    },
    "settingDialog\0on_applyButton_clicked\0"
    ""
};
...
void *settingDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui::settingDialog"))
        return static_cast< Ui::settingDialog*>(const_cast< settingDialog*>(this));
